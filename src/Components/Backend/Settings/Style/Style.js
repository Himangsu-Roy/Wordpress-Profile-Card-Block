      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              <strong>{__("Profile Image Border Gradient", "b-blocks")}</strong>
            </p>
            ...
            <ColorGradientControl
              ...
              colorValue={cardBorderColor}
              gradientValue={avatarBorderGradient}
              colors={[
                { name: "red", color: "#f00" },
                { name: "white", color: "#fff" },
                { name: "blue", color: "#00f" },
              ...
              onGradientChange={(newValue) => {
                console.log(newValue, "gradient change");
                setAttributes({
                  styles: { ...styles, avatarBorderGradient: newValue },
                });
              }}
            />
          </PanelBody>
          ...
          >
            ...
            <ColorGradientControl
              title={__("Profile Image Border Gradient", "b-blocks")}
              colorValue={cardBorderColor}
              gradientValue={textContentGradient}
              colors={[
                { name: "red", color: "#f00" },
                { name: "white", color: "#fff" },
                { name: "blue", color: "#00f" },
              ...
              onGradientChange={(newValue) => {
                console.log(newValue, "gradient change");
                setAttributes({
                  styles: { ...styles, textContentGradient: newValue },
                });
              }}
            />
          </PanelBody>
          ...
          >
            <BoxControl
              ...
              onChange={(newValue) =>
                setAttributes({
                  cardLayout: { ...cardLayout, borderRadius: newValue },
                })
              }
            />
          ...
          >
            ...
            <RangeControl
              ...
              max={10}
              step={0.1}
              onChange={(value) => setAttributes({ nameLetterSpacing: value })}
            />
