...
import {
  ...
  __experimentalVStack as VStack, Disabled, TextControl, DateTimePicker, Dashicon, __experimentalFlyout as Flyout, CustomSelectControl, __experimentalConfirmDialog as ConfirmDialog, __unstableComposite as Composite, ColorPicker, ColorPalette, ColorIndicator, ClipboardButton, CircularOptionPicker, CheckboxControl, __experimentalHeading as Heading, __experimentalText as Text, CardMedia, CardHeader, FlexBlock, FlexItem, CardFooter, CardBody, CardDivider, Card, ButtonGroup, BaseControl, PanelBody, SelectControl, __experimentalInputControl as InputControl, Button,
  Guide,
  TextareaControl,
...
const EnhancedComponent = withFocusReturn(() => (
  <div>
    ...
    <TextControl
      ...
      autoFocus={true}
      onChange={(fr) => { console.log(fr) }}
    />
  </div>
));


const General = ({ attributes, setAttributes, fallbackTextColor, fallbackBackgroundColor }) => {
  ...
  return (
    <PanelBody className='bPlPanelBody' title={__('Purpose', 'b-blocks')} initialOpen={false}>
      ...
      <ButtonGroup>
        ...
        <Button onClick={handleClick} variant="primary">Button 2</Button>
      </ButtonGroup>
